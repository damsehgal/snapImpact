 ...
 */
public class FoodComplaintFragment extends Fragment
{
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
	{
		...
		View rootView = inflater.inflate(R.layout.fragment_food_complaint, container, false);
		send = (Button) rootView.findViewById(R.id.fragment_complaint_food_send);
		camera = (Button) rootView.findViewById(R.id.fragment_complaint_food_camera);
		gallery = (Button) rootView.findViewById(R.id.fragment_complaint_food_gallery);
		image = (ImageView) rootView.findViewById(R.id.fragment_complaint_food_image_view);
		name = (EditText) rootView.findViewById(R.id.fragment_complaint_food_name);
		age = (EditText) rootView.findViewById(R.id.fragment_complaint_food_age);
	...
	{
		return new FoodComplaintFragment();
	}
