 ...
 */
public class ComplaintPatholeFragment extends Fragment
{
	...
	public ComplaintPatholeFragment()
	{
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
	{
		...
		View rootView = inflater.inflate(R.layout.fragment_complaint_pathole, container, false);
		send = (Button) rootView.findViewById(R.id.fragment_complaint_pathole_send);
		camera = (Button) rootView.findViewById(R.id.fragment_complaint_pathole_camera);
		gallery = (Button) rootView.findViewById(R.id.fragment_complaint_pathole_gallery);
		image = (ImageView) rootView.findViewById(R.id.fragment_complaint_pathole_image_view);
		name = (EditText) rootView.findViewById(R.id.fragment_complaint_pathole_name);
		age = (EditText) rootView.findViewById(R.id.fragment_complaint_pathole_age);
	...
	{
		return new ComplaintPatholeFragment();
	}
